          ...
          <div className="mt-3 flex flex-wrap items-center gap-3">
            {resolvedStayLink && (
              <a
                ...
                className="inline-flex min-h-10 items-center gap-1 rounded-xl border border-[#D94A32] bg-[#fff3e7] px-3 py-2 text-xs font-semibold text-[#b44b00] hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-orange-200"
              >
                {stayLabel}
            ...
            {bookingCta && (
              <a
                ...
                className={[
                  ...
                  isBookingExternal
                    ? "border-[#D94A32] bg-[#fff3e7] text-[#b44b00] hover:bg-white focus-visible:ring-orange-200"
                    : "border-[#9fd7bd] bg-[#f0fbf6] text-[#106b43] hover:border-[#2E7D5B] hover:bg-white focus-visible:ring-emerald-200",
                ].join(" ")}
              >
                {bookingCta.label}
            ...
            {prepareCta && (
              <a
                ...
                className="inline-flex min-h-10 items-center gap-1 rounded-xl border border-[#9fd7bd] bg-[#f0fbf6] px-3 py-2 text-xs font-semibold text-[#106b43] hover:border-[#2E7D5B] hover:bg-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-emerald-200"
              >
                {prepareCta.label}
                <ArrowRight className="h-3 w-3" />
              </a>
