...
export const itineraryPages: ItineraryPage[] = [
  ...
  },
  {
    ...
    proTip: "With only 5 days, a JR Pass may not pay off unless you're doing the Tokyo–Kyoto round trip. As a rough benchmark, a Shinkansen one-way ticket is usually around ¥13,000–14,000, while a 7-day JR Pass is usually around ¥50,000. If flying out of KIX (one-way Shinkansen), individual tickets are usually simpler.",
    nextActions: commonNextActions,
  },
  {
...

  {
    ...
    days: [
      ...
      },
      {
        ...
        bookingCta: { label: "Osaka → KIX routes", href: "/airport-transfers#kansai-airport-routes", category: "transfer" },
      },
    ],
  ...
  },
  {
    ...
    days: [
      ...
      },
      {
        ...
        highlights: ["Buy a Shinkansen ticket at Tokyo Station or online (usually around ¥13,000–14,000 one-way)", "Tokaido Shinkansen Tokyo → Kyoto (2h15m)", "Sit on the right side (Seat E) for Mt. Fuji views", "Afternoon: Fushimi Inari torii gates"],
        stayArea: "Kyoto Station area",
        stayLink: hotelKyotoStation.href,
        stayHotelKey: "kyotoStation",
        transport: "Shinkansen single ticket (usually around ¥13,000–14,000)",
        bookingCta: { label: "Book Shinkansen ticket", href: shinkansenTicketUrl, category: "train" },
        prepare: "Check Fuji-side seat",
        prepareCta: { label: "Which seat for Fuji?", href: "/tokyo-to-kyoto-mt-fuji-seat" },
      },
      {
        ...
        highlights: ["Morning: Kinkaku-ji → Ryoan-ji", "Afternoon: Arashiyama bamboo grove", "Evening: Gion walk and Pontocho dinner", "Local transport: city bus day pass or IC card, usually around a few hundred yen"],
        stayArea: "Kyoto Station area",
        stayLink: hotelKyotoStation.href,
        stayHotelKey: "kyotoStation",
        bookingCta: { label: "See Kyoto activities", href: kyotoUrl, category: "activity" },
      ...
      },
      {
        ...
        highlights: ["Take JR Special Rapid to Osaka (30 min, usually around ¥600 — no JR Pass needed)", "This is a local train, covered by IC card", "Afternoon: Osaka Castle or Shinsekai", "Evening: Dotonbori street food"],
        stayArea: "Namba / Dotonbori",
        stayLink: hotelNamba.href,
        stayHotelKey: "namba",
        transport: "JR Special Rapid (30 min, usually around ¥600 on IC card)",
        bookingCta: { label: "See Osaka activities", href: osakaUrl, category: "activity" },
      ...
      },
      {
        ...
        location: "Osaka → Depart",
        title: "Departure day",
        highlights: ["Morning: Kuromon Market or last shopping", "Head to KIX — Nankai Rapi:t or JR Haruka (both are single tickets, no pass)", "Or Shinkansen back to Tokyo (usually around ¥14,000) if flying from Narita/Haneda"],
        transport: "Nankai Rapi:t to KIX (usually around ¥1,500) or Shinkansen to Tokyo",
