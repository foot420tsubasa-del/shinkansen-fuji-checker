...
const rawStayPages: StayPage[] = [
  ...
  },
  {
    ...
    areas: [
      ...
      },
      {
        ...
        cons: ["15 min bus or taxi to Kyoto Station", "Luggage handling more difficult — narrow streets, fewer lockers", "Higher hotel prices for ryokan-style stays", "Public transport less convenient than station area"],
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Kyoto Station": "¥6,000–12,000", "Gion": "¥10,000–25,000" } },
    ],
    ...
    nextActions: [
      ...
      { id: "airport-kansai-kyoto", category: "transfer", title: "Kansai Airport → Kyoto", description: "Haruka express, bus, and transfer options.", cta: "See routes", href: "/airport-transfers/kansai-airport-to-kyoto" },
      { id: "airport-kyoto-kansai", category: "transfer", title: "Kyoto → Kansai Airport", description: "Departure-day routes from Kyoto to KIX.", cta: "See routes", href: "/airport-transfers/kyoto-to-kansai-airport" },
...

  {
    ...
    areas: [
      {
        ...
        cons: ["Higher hotel prices", "Quiet after 9pm — mostly offices", "Less neighborhood character"],
      ...
      },
      {
        ...
        pros: ["Cheapest central hotel area", "Skyliner to Narita 36 min", "Some Shinkansen stop at Ueno Station"],
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Tokyo Stn": "¥9,000–18,000", "Shinjuku": "¥6,000–12,000", "Ueno": "¥4,500–8,000", "Asakusa": "¥5,000–9,000" } },
    ],
  ...
  },
  {
    ...
    areas: [
      {
        ...
        cons: ["Higher hotel prices", "Quiet after 9pm — mostly offices", "Less character as a neighborhood"],
        bestFor: "Shinkansen-heavy trips",
      ...
      },
      {
        ...
        pros: ["Best train connectivity in Tokyo (12 lines)", "Huge hotel selection at every price", "Golden Gai, Omoide Yokocho, Kabukicho walking distance"],
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Tokyo Station": "¥9,000–18,000", "Shinjuku": "¥6,000–12,000" } },
  ...
  },
  {
    ...
    areas: [
      {
        ...
        name: "Ueno",
        vibe: "Calm, cultural, budget-friendly",
        pros: ["Cheapest hotel area in central Tokyo", "Skyliner to Narita in 36 min — fastest airport link", "Ueno Park: museums, zoo, cherry blossoms", "Ameyoko market for street food and bargains"],
      ...
      },
      {
        ...
        cons: ["Station is enormous — expect confusion at first", "Hotel prices spike on weekends", "Narita Express takes 80 min"],
        bestFor: "Nightlife + flexibility",
        transport: "10 min to Tokyo Station. Narita Express direct. Odakyu to Hakone.",
        hotelLink: hotelShinjuku.href,
        hotelKey: "shinjuku",
    ...
    comparison: [
      ...
      { feature: "Hotel budget", values: { "Ueno": "¥4,500–8,000", "Shinjuku": "¥6,000–12,000" } },
  ...
  },
  {
    ...
    areas: [
      ...
      },
      {
        ...
        cons: ["15 min bus/taxi to Kyoto Station", "Narrow streets — luggage is difficult", "Higher prices, especially ryokan"],
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Kyoto Station": "¥6,000–12,000", "Gion": "¥10,000–25,000", "Kawaramachi": "¥7,000–15,000" } },
    ],
    ...
    nextActions: [
      ...
      { id: "airport-kansai-kyoto", category: "transfer", title: "Kansai Airport → Kyoto", description: "Haruka express, bus, and private transfer options.", cta: "See routes", href: "/airport-transfers/kansai-airport-to-kyoto" },
  ...
  },
  {
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Namba": "¥5,000–10,000", "Umeda": "¥6,000–12,000", "Shin-Osaka": "¥5,500–10,000" } },
    ...
    nextActions: [
      ...
      { id: "airport-kansai-namba", category: "transfer", title: "Kansai Airport → Namba", description: "Nankai Rapi:t, bus, and transfer options to Namba.", cta: "See routes", href: "/airport-transfers/kansai-airport-to-namba" },
      { id: "airport-kansai-umeda", category: "transfer", title: "Kansai Airport → Umeda", description: "JR, bus, and transfer options to Umeda / Osaka Station.", cta: "See routes", href: "/airport-transfers/kansai-airport-to-umeda" },
      { id: "airport-osaka-kansai", category: "transfer", title: "Osaka → Kansai Airport", description: "Departure-day routes from Osaka to KIX.", cta: "See routes", href: "/airport-transfers/osaka-to-kansai-airport" },
  ...
  },
  {
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Namba": "¥5,000–10,000", "Umeda": "¥6,000–12,000" } },
    ],
    ...
    nextActions: [
      ...
      { id: "airport-kansai-namba", category: "transfer", title: "Kansai Airport → Namba", description: "Nankai Rapi:t, bus, and transfer options.", cta: "See routes", href: "/airport-transfers/kansai-airport-to-namba" },
      { id: "airport-kansai-umeda", category: "transfer", title: "Kansai Airport → Umeda", description: "JR, bus, and transfer options to Umeda.", cta: "See routes", href: "/airport-transfers/kansai-airport-to-umeda" },
      { id: "airport-osaka-kansai", category: "transfer", title: "Osaka → Kansai Airport", description: "Departure-day routes from Osaka to KIX.", cta: "See routes", href: "/airport-transfers/osaka-to-kansai-airport" },
      { id: "seat", category: "train", title: "Check Fuji-side seat", description: "Find the right window seat for Mt. Fuji views.", cta: "Check seat", href: "/guide" },
      ...commonNextActions,
    ],
  ...
  },
  {
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Shin-Osaka": "¥5,500–10,000", "Namba": "¥5,000–10,000" } },
    ],
  ...
  },
  {
    ...
    areas: [
      {
        ...
        cons: ["Business district — quiets down after 8pm", "Higher hotel prices around the station", "Less character than Shinjuku or Asakusa"],
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Tokyo Station": "¥8,000–15,000", "Shinjuku": "¥6,000–12,000", "Ueno": "¥4,000–9,000", "Asakusa": "¥5,000–10,000" } },
    ],
    ...
    faqs: [
      ...
      { question: "Which area is cheapest near Tokyo Station?", answer: "Ueno has the most budget options. It's just 7 minutes from Tokyo Station by JR and also has direct Narita Skyliner access. Tokyo Station itself has premium pricing." },
  ...
  },
  {
    ...
    comparison: [
      ...
      { feature: "Typical budget", values: { "Asakusa": "¥5,000–10,000", "Ueno": "¥4,000–9,000" } },
    ],
    ...
    faqs: [
      { question: "Is Asakusa or Ueno better for first-time Tokyo?", answer: "Ueno is more practical — direct Narita Skyliner, 7 min to Tokyo Station, cheaper hotels. Asakusa is more atmospheric with Senso-ji and old-town charm. They're only 5 min apart by Metro, so you can easily visit both." },
