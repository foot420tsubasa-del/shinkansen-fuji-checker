...
export const transferPages: TransferPage[] = [
...

  {
    ...
    lateArrivalNote: "The last JR Haruka to Kyoto departs around 22:15. If your flight lands after 21:00, check Haruka schedules carefully before relying on rail. After the last train, a private transfer or airport hotel near KIX is your best option — a taxi to Kyoto costs ¥30,000+.",
  ...
  },
  {
    ...
    proTip: "Namba is the best Osaka base for Dotonbori street food and nightlife. The Nankai Rapi:t gets you there in 34 minutes with luggage space — it's the obvious first choice. If you want to save ¥500, the Airport Express is nearly as fast.",
    nextActions: kansaiBundle(
