...
const guideUiByLocale = {
  ...
  "pt-BR": {
    ...
    checkJrPassButton: "Ver JR Pass", quickKlookTitle: "Reserve o assento E após confirmar sua direção", quickKlookNote: "Reserve seu bilhete de Shinkansen em inglês e selecione o assento do lado do Fuji quando disponível.", quickKlookButton: "Reservar bilhete de Shinkansen na Klook", dirToKyoto: "Reservar Tóquio → Kyoto / Osaka", dirToTokyo: "Reservar Kyoto / Osaka → Tóquio", dirSeatNote: "Escolha o assento E no mapa de assentos quando disponível.", bookCtaButton: "Reservar o assento E na Klook", bookCtaNote: "Escolha a rota primeiro e depois o assento E quando a seleção estiver disponível.", omioLead: "Comparando o trem com ônibus ou voos?", omioLink: "Veja outras opções de rota na Omio.", stickyConfirmed: "Assento E confirmado", stickyButton: "Reservar na Klook",
  ...
  es: {
    ...
    bookShinkansenButton: "Reservar Shinkansen",
    checkJrPassButton: "Ver JR Pass", quickKlookTitle: "Reserva el asiento E tras confirmar tu dirección", quickKlookNote: "Reserva tu billete de Shinkansen en inglés y elige el asiento del lado del Fuji cuando esté disponible.", quickKlookButton: "Reservar billete de Shinkansen en Klook", dirToKyoto: "Reservar Tokio → Kioto / Osaka", dirToTokyo: "Reservar Kioto / Osaka → Tokio", dirSeatNote: "Elige el asiento E en el mapa de asientos cuando esté disponible.", bookCtaButton: "Reservar el asiento E en Klook", bookCtaNote: "Elige primero la ruta y luego el asiento E cuando la selección esté disponible.", omioLead: "¿Comparando el tren con autobuses o vuelos?", omioLink: "Ver otras opciones de ruta en Omio.", stickyConfirmed: "Asiento E confirmado", stickyButton: "Reservar en Klook",
